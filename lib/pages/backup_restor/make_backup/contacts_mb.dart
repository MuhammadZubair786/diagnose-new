          ...
          child: Column(
            children: [
                  ...
                  : ListView.builder(
                    ...
                    physics: NeverScrollableScrollPhysics(),
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        var username = contacts![index].name.first+contacts![index].name.last;
                        var ischeck=false;
                        print(username);
              ...
              leading: contacts![index].name.first == null
                      ...
                      : 
                      username.length>15? 
                      Text(username.substring(0,username.length-5), style: TextStyle(fontWeight: FontWeight.bold)):

                      Text(username, style: TextStyle(fontWeight: FontWeight.bold)),

                      // title: ,
              title:   Center(child:contacts![index].phones.first.number ==null ? Text("No number ") : Text('${contacts![index].phones.first.number}', )),
              trailing: Checkbox(
                        value: ischeck,
